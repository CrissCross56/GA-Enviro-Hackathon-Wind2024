...
export default function Pollutants(props) {
    ...
    return (
        ...
        <div className={styles.pollutants}>
            ...
            <hr className={styles.separator}/>
            <ProgressBar name={'Carbon Dioxide'} buffer={'............'} pollutant={`CO2`} value={props.n02} max={1250}  units={`ppb`} good={53} moderate={100} unhealthySens={360} unhealthy={649} veryUnhealthy={1249} hazardous={1250}></ProgressBar>
        </div>
    )
 }
